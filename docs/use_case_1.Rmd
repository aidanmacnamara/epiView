...
We can look at the correlation in the signal between 'U937 PMA+LPS' and the primary data in a little more detail by selecting **Scatterplot** on the left panel:
